        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="flex justify-end p-3">
                    ...
                    <div class="p-6 text-gray-900">
                        <label class=" text-2xl">Add Customer Details</label>
                        <p class="mt-1 text-md leading-6 text-gray-600">You can add new customer details by filling up the form below.</p>
                    <hr>
                                        ...
                                        <h2 class="text-base font-semibold leading-7 text-gray-900">Personal Information</h2>
                                            ...
                                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                                ...
                                                <div class="sm:col-span-3">
                                                    ...
                                                    <div class="mt-2">
                                                        <input type="date" name="latest_payment" required id="latest_payment" autocomplete="given-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                                    </div>
                                                </div>
