                                        ...
                                        <h2 class="text-base font-semibold leading-7 text-gray-900">Customer Billing Form</h2>
                                            ...
                                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                                ...
                                                <div class="sm:col-span-3">
                                                    ...
                                                    <div class="mt-2">
                                                            ...
                                                            focus:ring focus:ring-indogo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                                                                ...
                                                                <option class="text-sm text-gray-700" value="{{ $package->id }}">{{ $package->id }} - {{ $package->package_number }} - {{ $package->package_name }} -
                                                                    {{ $package->package_price }}</option>
                                                           @endforeach
                                                            </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="sm:col-span-3">
                                                    ...
                                                    <p class="mt-1 text-sm leading-6 text-gray-600">If not paid yet, please select Due/Unpaid.</p>
                                                    <div class="mt-2">
