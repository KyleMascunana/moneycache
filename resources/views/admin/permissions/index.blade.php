    ...
    <div class="py-12 w-full">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-lg md:rounded-lg p-2">
                <label class="uppercase text-2xl font-extrabold pl-5">Permissions List</label>
                <p class="mt-1 text-sm leading-6 text-gray-600 pl-5">You can view or add new permission to the system here.</p>
                <hr>
                    <div class="flex justify-end p-3">
                        <a href="{{ route('admin.permissions.create') }}" class="px-4 py-2 bg-green-700 hover:bg-green-500 text-white rounded-md">Add Permission</a>
                    </div>
                <div class="flex flex-col">
                    <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                        <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                            <div class="min-w-full divide-y divide-gray-200">
                                <table class="display text-sm uppercase text-gray-600">
                                                ...
                                                <div class="items-center">
                                                    <div class="flex space-x-5">
                                                        <a href="{{ route('admin.permissions.edit', $permission->id) }}" class="px-4 py-2 bg-blue-500
                                                            hover:bg-blue-700 text-white rounded-md">
