                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-3 mt-2">
                            <div class="flex justify-end p-3">
                                <a href="{{ route('admin.package.create') }}" class="px-4 py-2 bg-green-700 hover:bg-green-500 text-white
                                    ...
                                    <td>
                                        <div class="items-center">
                                            <div class="flex space-x-3">
                                                ...
                                                <form action="{{ route('admin.package.destroy', $package->id) }}" method="POST" onsubmit="return confirm('Are you sure?');">
                                                    @csrf
                                                    @method('DELETE')
