...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="relative min-h-screen md:flex" x-data="{ open: true }">
            <!-- Sidebar -->
            <aside :class="{ '-translate-x-full': !open }" class="z-10 bg-gray-800 text-gray-100 w-64 px-2 py-4 absolute inset-y-0
                ...
                <!-- Logo -->
                    <div class="flex items-center justify-between px-2">
                        <div class="flex items-center space-x-2">
                            ...
                            <span class="text-2xl font-extrabold">User</span>
                        </div>
                        ...
                        <div class="relative flex items-center justify-between md:justify-end h-16">
                            ...
                            <div class="absolute inset-y-0 right-0 flex items-center">
                                <x-dropdown align="right" width="48">
                                    <x-slot name="trigger">
                                        <button class="flex items-center font-medium text-blue-100 hover:bg-blue-700
