        ...
        <div class="relative min-h-screen md:flex" x-data="{ open: true }">
            ...
            <aside :class="{ '-translate-x-full': !open }" class="z-10 bg-gray-200 text-blue-600 w-64 px-2 py-4 absolute inset-y-0
                ...
                <nav class=" pt-2">
                    ...
                    <x-side-nav-link href="{{ route('admin.package.index') }}" :active="request()->routeIs('admin.package.index')">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <div class="p-2.5 font-semibold flex items-center rounded-md px-4 duration-300 cursor-pointer hover:text-gray-200 hover:bg-blue-600">
                      ...
                      <div class="leading-7 text-left text-md font-semibold w-full mx-auto" id="submenu1">
                        <x-side-nav-link href="{{ route('admin.customers.create') }}" :active="request()->routeIs('admin.customers.create')">
                        ...
                        <x-side-nav-link href="{{ route('admin.customers.index') }}" :active="request()->routeIs('admin.customers.index')">
                            <div class="flex item-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <x-side-nav-link href="{{ route('admin.details.index') }}" :active="request()->routeIs('admin.details.index')">
                            <div class="flex item-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M2.25 6v9m18-10.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 0h.008v.008H6V10.5Z" />
                                  </svg>
                                  <span class="ml-2">View Billing History</span>
                            </div>
                        </x-side-nav-link>
                      </div>
                    <hr>
                    <x-side-nav-link href="{{ route('admin.report.index') }}" :active="request()->routeIs('admin.report.index')">
                        <div class="flex items-center">
                            ...
                            <span class="ml-2">Report List</span>
                        </div>
                    </x-side-nav-link>
                    ...
                    <div class="p-2.5 font-semibold flex items-center rounded-md px-4 duration-300 cursor-pointer hover:text-gray-200 hover:bg-blue-600">
                      ...
                      <hr>
                      <div class="leading-7 text-left text-md font-semibold w-full mx-auto" id="submenu2">
                        <x-side-nav-link href="{{ route('admin.templateone.create') }}" :active="request()->routeIs('admin.templateone.create')">
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        <x-side-nav-link href="{{ route('admin.templateone.index') }}" :active="request()->routeIs('admin.templateone.index')">
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="m15.75 10.5 4.72-4.72a.75.75 0 0 1 1.28.53v11.38a.75.75 0 0 1-1.28.53l-4.72-4.72M4.5 18.75h9a2.25 2.25 0 0 0 2.25-2.25v-9a2.25 2.25 0 0 0-2.25-2.25h-9A2.25 2.25 0 0 0 2.25 7.5v9a2.25 2.25 0 0 0 2.25 2.25Z" />
                                  </svg>
                                <span class="ml-2">View Templates</span>
                            </div>
                        </x-side-nav-link>
                      </div>
                      <hr>
                    <div class="p-2.5 font-semibold flex items-center rounded-md px-4 duration-300 cursor-pointer hover:text-gray-200 hover:bg-blue-600">
                        ...
                        <div class="flex justify-between w-full items-center" onclick="dropDown()">
                          <span class="text-[15px] text-lue-600">
                            <div class="flex items-center">
                                ...
                                <span class="ml-2">Advance Settings</span>
                            </div>
                            </span>
                      ...
                      <hr>
                      <div class="leading-7 text-left text-md font-semibold w-full mx-auto" id="submenu">
                        <x-side-nav-link href="{{ route('admin.users.index') }}" :active="request()->routeIs('admin.users.index')">
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M18 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0ZM3 19.235v-.11a6.375 6.375 0 0 1 12.75 0v.109A12.318 12.318 0 0 1 9.374 21c-2.331 0-4.512-.645-6.374-1.766Z" />
                                  </svg>
                                <span class="ml-2">User Panel</span>
                            </div>
                        </x-side-nav-link>

                        <x-side-nav-link href="{{ route('admin.roles.index') }}" :active="request()->routeIs('admin.roles.index')">
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M6 13.5V3.75m0 9.75a1.5 1.5 0 0 1 0 3m0-3a1.5 1.5 0 0 0 0 3m0 3.75V16.5m12-3V3.75m0 9.75a1.5 1.5 0 0 1 0 3m0-3a1.5 1.5 0 0 0 0 3m0 3.75V16.5m-6-9V3.75m0 3.75a1.5 1.5 0 0 1 0 3m0-3a1.5 1.5 0 0 0 0 3m0 9.75V10.5" />
                                  </svg>
                                <span class="ml-2">Role Panel</span>
                            </div>
                        </x-side-nav-link>

                        <x-side-nav-link href="{{ route('admin.permissions.index') }}" :active="request()->routeIs('admin.permissions.index')">
                            <div class="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
                                  </svg>
                                <span class="ml-2">Permission Panel</span>
                            </div>
                        </x-side-nav-link>
                      </div>
                      <hr>
